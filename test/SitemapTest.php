...
class SitemapTest extends \Windwalker\Test\TestCase\DomTestCase
{
	...
	{
		$this->instance->addUrlItem('http://windwalker.io');
...
XML;
		...
		$this->instance->addUrlItem('http://windwalker.io/foo/bar/?flower=sakura&fly=bird', '1.0', ChangeFreq::DAILY, '2015-06-07 10:51:20');
